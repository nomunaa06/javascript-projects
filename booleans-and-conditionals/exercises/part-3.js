...
// 6) a) Create the variable commandOverride, and set it to be true or false. If commandOverride is false, then the shuttle should only 
//launch if the fuel and engine check are OK. If commandOverride is true, then the shuttle will launch regardless of the fuel and engine status.
if (commandOverride=== false){
 if (fuelLevel > 20000 && engineTemperature <= 2500 && engineIndicatorLight === "green") 
    {console.log("Launch 10, 9, 8, 7 ...");}
}
else console.log("Launch 10, 9, 8, 7 ...");
...
if (fuelLevel>20000 && engineIndicatorLight!="red blinking"|| commandOverride===true){ HTMLFormControlsCollection.log ("Cleared to launch!");}
